...
def home_screen():
    global home
    for i in range(clock.tick(50)):
        slide_f_r()
    
    for i in range(clock.tick(10)):
        slide_f_l()    


def running():
    global is_jump, is_jumpy, reverse, is_shoot, end_game, falling_f, f_x, f_y, f_h, g_y, falling_g, words, words_x, words_y, reply, g_x, reply1, words1, words2
